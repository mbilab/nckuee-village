...
Class.create("RPGJS", {
    ...
    ready: function (b) {
        var a = this;
        RPGJS_Canvas = CE.defines(this.params.canvas, this.params).extend([Animation, Input, Spritesheet, Scrolling, Window, Text, Effect]).ready(function () {
    ...
    scene: {
        ...
        call: function (a, b) {
            return RPGJS_Canvas.Scene.call(a, b)
        },
        load: function (a, f, b) {
            var c = 0;
            b = b || "";
            ...
            for (var d = 0; d < a.length; d++) {
                name = a[d];
                RPGJS.loadScript(b + "core/scene/" + name, function () {
                    e()
                })
            }
        }
    ...
    Plugin: {
        ...
        _refreshScene: function () {
            for (var a = 0; a < this.list.length; a++) {
                this.list[a].Sprite.scene = RPGJS_Canvas.Scene.get("Scene_Map")
            }
        },
        add: function (c, g) {
            var b, f, k = this,
            ...
            function h(l, u) {
                ...
                function t(w, v) {
                    ...
                    if (r == 2 && u) {
                        ...
                        q.Sprite.scene = RPGJS_Canvas.Scene.get("Scene_Map");
                        k.list.push(q);
                        u()
                    }
                }
                var m = RPGJS_Canvas.Materials.getBasePath(l),
                    o = RPGJS_Canvas.Materials.getFilename(l),
                    n = ["", ""];
                ...
                RPGJS.loadScript(n[0], function () {
                    t("Game", o)
                });
                RPGJS.loadScript(n[1], function () {
                    t("Sprite", o)
                })
            }
    ...
    Path: {
        ...
        loadMaterial: function (b, f, e) {
            var d = {}, a = this.isSound(b) ? "sounds" : "images";
            var c = this.get(b, f);
            d[b + "_" + f] = c;
            if (RPGJS_Canvas.Materials.sounds[b + "_" + f]) {
                if (e) {
                    e()
                }
            }
            RPGJS_Canvas.Materials.load(a, d, e)
        },
        load: function (c, a, f, e) {
            var d = {}, b = this.isSound(c) ? "sounds" : "images";
            d[c + "_" + f] = this[c] + a;
            RPGJS_Canvas.Materials.load(b, d, e)
        }
    }
});
...
//                            e = e.replace(/'/g, '"');
    ...
    cmdBlink: function (c) {
        ...
        global.game_map.callScene("blink", [d, c.duration, c.frequence,
            function () {
                if (c.wait != "_no") {
                    b()
                }
    ...
    cmdCallSave: function () {
        var a = RPGJS.scene.call("Scene_Load");
        a.refresh("save")
    },
...
Class.create("Game_System", {
    ...
    fadeOutMusic: function (b) {
        ...
        if (this._current.bgm) {
            RPGJS_Canvas.Sound.fadeOut("bgms_" + this._current.bgm, b, function () {
                a._stopAudio(a._current.bgm, "bgm")
            })
        }
        if (this._current.bgs) {
            RPGJS_Canvas.Sound.fadeOut("bgss_" + this._current.bgs, b, function () {
    ...
    fadeOutSound: function (b) {
        var a = this;
        if (this._current.me) {
            RPGJS_Canvas.Sound.fadeOut("mes_" + this._current.me, b, function () {
                a._stopAudio(a._current.me, "me")
            })
        }
        if (this._current.se) {
            RPGJS_Canvas.Sound.fadeOut("ses_" + this._current.se, b, function () {
    ...
    _playAudio: function (b, a) {
        ...
        this._current[a] = b;
        RPGJS.Path.loadMaterial(a + "s", b, function () {
            RPGJS_Canvas.Sound.playLoop(a + "s_" + b)
        })
    },
    _stopAudio: function (b, a) {
        this._current[a] = null;
        RPGJS_Canvas.Sound.get(a + "s_" + b).pause()
    }
});
...
Class.create("Game_CommonEvents", {
    ...
    exec: function (e, d) {
        ...
        if (b) {
            ...
            a = Class.New("Interpreter", [this.event, CE.clone(b.commands)]);
            a.execCommands(d)
        }
    }
});
...
var _class = {
    ...
    passable: function (m, u, t, l, h, D) {
                ...
                if (!E(c.result.coincident)) {
                    ...
                    if (c.over == 1) {
                        if (C.trigger == "contact") {
                            ...
                            RPGJS.Plugin.call("Game", "eventContact", [C, this])
                        }
                    }
                    if (C.through) {
        ...
        if (m.id != 0) {
            ...
            if (c.over >= 1 && !E(c.result.coincident)) {
                RPGJS.Plugin.call("Game", "contactPlayer", [m, this]);
                return {
                    passable: false,
                    x: u,
                    y: t
    ...
    execEvent: function () {
        ...
        for (var b in this.events) {
            ...
            if (a && a._hit && a.trigger == "action_button") {
                RPGJS.Plugin.call("Game", "execEvent", [a, this]);
                a.execTrigger()
            }
        }
    },
    ...
    loadEvent: function (c, f, g) {
        ...
        var a = f ? global.data[c][f] : RPGJS.getGlobalEvent(this.map_id, c);
        if (a) {
            d(a)
        } else {
    ...
    removeEvent: function (a) {
        RPGJS.Plugin.call("Game", "removeEvent", [this.events[a], this]);
    ...
    execAction: function (a) {
        RPGJS.Plugin.call("Game", "action", [this.actions_data[a], a, this])
    },
    tick: function () {
        var a = this;
        setInterval(function () {
            RPGJS.Plugin.call("Game", "tick", [a])
        }, 1000 / 60)
    },
    clear: function () {
...
Class.create("Game_Character", {
    ...
    detectionEvents: function (c, a) {
        ...
        RPGJS.Plugin.call("Game", "eventDetected", [d, this]);
        return d
    },
    ...
    serialize: function () {
        ...
        RPGJS.Plugin.call("Game", "serializeCharacter", [c, this]);
        return c
    },
    ...
    changeParamPoints: function (e, b, c) {
        ...
        RPGJS.Plugin.call("Game", "changeParamPoints", [e, b, c, this]);
        return g
    },
    ...
    addItem: function (b, d, a) {
        ...
        RPGJS.Plugin.call("Game", "addItem", [b, d, a, this])
    },
...
Class.create("Spriteset_Map", {
    ...
    tilemap: function (p) {
        ...
        if (this.params.autotiles) {
            ...
            CE.each(this.params.autotiles, function (v, x) {
                ...
                var w = RPGJS_Canvas.Materials.images[x];
                u.width = w.width;
                u.height = w.height;
                h.drawImage(w, 0, 0);
                for (j = 0; j < 7; j++) {
        ...
        var n = this.data.data.map,
            o = this.data.autotiles || {}, f = this.data.propreties || {}, g = RPGJS_Canvas.Materials.get("tileset"),
            t, m, b;
        this.width = n.length;
    ...
    addCharacter: function (b) {
        ...
        this.events[b.id] = a;
        RPGJS.Plugin.call("Sprite", "addCharacter", [a, b, this])
    },
    ...
    movePicture: function (f, d, e, b) {
        ...
        var a = RPGJS_Canvas.Timeline.New(c);
    ...
    rotatePicture: function (d, c) {
        ...
        var a = RPGJS_Canvas.Timeline.New(b);
        a.to({
            rotation: 360
        }, c).call(function () {
            b.rotation = 0
    ...
    effect: function (b, e, c) {
        var a = this;
        var d = RPGJS_Canvas.Effect.New(this.scene, this.map);
    ...
    scrollMap: function (c, b) {
        var a = this;
        this.scrolling.freeze = true;
        RPGJS_Canvas.Timeline.New(this.map).to({
            x: -c.x,
            y: -c.y
        }, 120).call(function () {
            a.scrolling.freeze = false;
...
Class.create("Sprite_Character", {
    ...
    initialize: function (d, c, b, a) {
        this.scene = d;
        this.entity = Class.New("Entity", [d.getStage(), {},
            false
        ]);
    ...
    refresh: function (d) {
        ...
        if (+this.graphic) {
            function c() {
                ...
                var e = RPGJS_Canvas.Materials.get("characters_" + a.graphic);
            ...
            if (this.id != 0) {
                RPGJS.Path.loadMaterial("characters", this.graphic, c)
            } else {
                c()
            }
        } else {
    ...
    initAnimationActions: function (e) {
        ...
        function h(p) {
            function o() {
                RPGJS_Canvas.Scene.get("Scene_Map").animation(0, e[p]["animation_finish"]);
                n.stop()
            }
            c = e[p];
            if (!c.graphic) {
            ...
            d = RPGJS_Canvas.Materials.get("characters_" + c.graphic);
            l = {
    ...
    playAnimationAction: function (b) {
        ...
        if (this._actions[b]) {
            ...
            RPGJS_Canvas.Scene.get("Scene_Map").animation(0, this._actions[b]["animation_" + a])
        }
    },
    setParameter: function (a, b) {
        this[a] = b;
