...
game.ev[map][id] = new game.Ev({
	...
	'CHOICES: ["是","否"]',
 	'CHOICE_0',
			s(ev+'.can_take()'),
			'IF: "1 == variable[0]"',
				t('常被用來傳送橫向電磁波的transmission line有三種類型，你知道在鄉村地區常用的電話線是屬於哪一種嗎? '),	
				'CHOICES: ["Parallel-plate transmission line","Two-wire transmission line","Coaxial transmission line"]',
				'CHOICE_0',
					s(ev+'.fail("答錯了！！！")'),
				'CHOICE_1',
