				...
				'CHOICE_0',
					...
					'IF: "0 == variable[0]"',
						...
						'IF: "1 == variable[0]"',
							...
							'CHOICE_0',
								game.script( 'take', ev ),
								"SHOW_PICTURE: {'id': '"+id+"_4', 'filename':'"+id+"_4.jpg','operand-type':'constant','x':300,'y':80}",
								game.show_text('%V[0]'),
								"ERASE_PICTURE: {'id': '"+id+"_4' }",
							'CHOICE_1',
								"SHOW_PICTURE: {'id': '"+id+"_1', 'filename':'"+id+"_1.jpg','operand-type':'constant','x':300,'y':80}",
								game.show_text('＜項羽＞同學…不是我喔…'),
								"ERASE_PICTURE: {'id': '"+id+"_1' }",
							'CHOICE_2',
								"SHOW_PICTURE: {'id': '"+id+"_2', 'filename':'"+id+"_2.jpg','operand-type':'constant','x':300,'y':80}",
								game.show_text('＜劉備＞同學…不是我喔…'),
								"ERASE_PICTURE: {'id': '"+id+"_2' }",
							'CHOICE_3',
								"SHOW_PICTURE: {'id': '"+id+"_3', 'filename':'"+id+"_3.jpg','operand-type':'constant','x':300,'y':80}",
